      ...
      <form onSubmit={handleSubmit} className="flex flex-col lg:w-96">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-3">
            <label htmlFor="reset1">{params.reset}</label>
            <ControledInput
              type={params.reset}
              id="reset1"
              placeholder={params.reset}
              value={field}
              onChange={setfield}
            />
          </div>
          <div className="flex flex-col gap-3">
            <label htmlFor="reset2">{`Confirm your ${params.reset}`}</label>
            <ControledInput
              type={params.reset}
              id="reset2"
              placeholder={`your new ${params.reset}`}
              value={fieldVerify}
              onChange={setfieldVerify}
            />
          </div>
        </div>
        <div className="pt-4">
